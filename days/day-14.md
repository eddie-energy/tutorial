...
<!-- TODO: How EDDIE interacts with AIIDA -->
...
For this you will need to start Keycloak in addition to the AIIDA services:
...
We requested AIIDA data to arrive in both raw data and CIM format.
Fetching the raw data topic from the REST outbound connector,
you should see a bunch of market documents generated by the AIIDA region connector.
...
```json
{
  "permissionId": "66efe7d0-f790-42c0-8f95-6049c81bbcde",
  "connectionId": "1",
  "dataNeedId": "00000000-0000-0000-0000-000000000004",
  "dataSourceInformation": {
    "countryCode": "aiida",
    "meteredDataAdministratorId": "aiida",
    "permissionAdministratorId": "aiida",
    "regionConnectorId": "aiida"
  },
  "timestamp": "2026-05-11T12:46:15.013001139Z",
  "rawPayload": "..."
}
```

As requested, our AIIDA records are also processed into CIM format available here:
